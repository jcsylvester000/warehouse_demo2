...
export const useWarehouseStore = defineStore('warehouse', {
  ...
  getters: {
    ...
    cartColorOptions(s) { const base = ['Black','White','Gray','Blue','Red','Green','Silver']; const set = new Set(base); (s.carts || []).forEach((c) => { if (c.cart_color) set.add(c.cart_color); }); return Array.from(set); },
    poCcOptions() { return ['cfo@carease.com', 'ops@carease.com', 'accounting@carease.com', 'warehouse@carease.com']; },
    stockReasonOptions() { return ['Cycle count', 'Damage', 'Correction', 'Theft / loss', 'Found', 'Return to stock', 'Expired / disposed', 'Vendor return']; },
